    ...
    function confirmDatePlugin(pluginConfig) {
        ...
        return function (fp) {
            ...
            return __assign({ onKeyDown: function (_, __, ___, e) {
                    ...
                    confirmContainer = fp._createElement(fp.calendarContainer.ownerDocument, "div", "".concat(confirmButtonCSSClass, " ").concat(config.showAlways ? "visible" : "", " ").concat(config.theme, "Theme"), config.confirmText);

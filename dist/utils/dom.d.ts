...
export declare function createElement<T extends HTMLElement>(doc: Document, tag: keyof HTMLElementTagNameMap, className: string, content?: string): T;
...
export declare function createNumberInput(doc: Document, inputClassName: string, opts?: Record<string, any>): HTMLDivElement;
